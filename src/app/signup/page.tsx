  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(217,70,239,0.16),_transparent_30%),linear-gradient(180deg,#110718_0%,#07050a_100%)] px-5 py-10 text-white">
      <div className="w-full max-w-md rounded-[32px] border border-white/10 bg-[#191027] p-6 shadow-2xl shadow-black/20">
        ...
        <p className="mt-6 text-xs uppercase tracking-[0.25em] text-fuchsia-300">Start free</p>
        <h1 className="mt-3 text-3xl font-semibold">Create your workspace account</h1>
        <p className="mt-3 text-sm leading-7 text-slate-300">
          Launch your own command center for leads, outreach, activity tracking, and project generation.
        </p>
        <AuthForm mode="signup" />
        <p className="mt-5 text-sm text-slate-400">
          Already signed up? <Link href="/login" className="text-fuchsia-300 hover:text-fuchsia-200">Log in</Link>
        </p>
      </div>
    </div>
  );
